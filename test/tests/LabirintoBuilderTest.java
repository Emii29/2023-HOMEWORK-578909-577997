...
public class LabirintoBuilderTest {
	...
	public void testBilocale() {
		Labirinto bilocale = labirintoBuilder
				...
				.getLabirinto();
				Map<String,Stanza> testAdiacenti1 = new HashMap<>();
				Map<String,Stanza> testAdiacenti2 = new HashMap<>();
				Stanza stanzaTest1 = new Stanza(nomeStanzaVincente);	
				Stanza stanzaTest2 = new Stanza(nomeStanzaVincente);
				testAdiacenti1.put("sud",stanzaTest1);
				testAdiacenti2.put("nord",stanzaTest2);
		assertEquals(bilocale.getStanzaVincente(),bilocale.getStanzaIniziale().getStanzaAdiacente("nord"));
		assertEquals(testAdiacenti2.keySet(),bilocale.getStanzaIniziale().getMapStanzeAdiacenti().keySet());
		assertEquals(testAdiacenti1.keySet(),bilocale.getStanzaVincente().getMapStanzeAdiacenti().keySet());
	}
	...
	public void testAggiuntaAttrezziAStanze_AppenaAggiunte() {
		...
		labirintoBuilder
				...
				.addAttrezzo(nomeAttrezzo, peso)
				.getLabirinto();
		assertTrue(this.labirintoBuilder.getListaStanze().get(nomeStanza).hasAttrezzo(nomeAttrezzo));
		assertEquals(new Attrezzo(nomeAttrezzo,peso).getNome(),this.labirintoBuilder.getListaStanze().get(nomeStanza).getAttrezzo(nomeAttrezzo).getNome());
	}
	...
	public void testAggiuntaAttrezzoAStanze_AppenaAggiunteMultiple() {
		...
		this.labirintoBuilder
				...
				.getLabirinto();
		Attrezzo attrezzo = new Attrezzo(nomeAttrezzo,peso);
		Attrezzo getAttrezzoDaMappa = labirintoBuilder.getListaStanze().get(nomeStanza).getAttrezzo(nomeAttrezzo);
		assertEquals(attrezzo.getNome(),getAttrezzoDaMappa.getNome());
	}
	...
	public void testAggiuntaAttrezzoAStanze_MoltepliciAttrezziStessaStanza() {
		...
		assertEquals(new Attrezzo(nomeAttrezzo2,peso2).getNome(),listaStanze.get(nomeStanza1).getAttrezzo(nomeAttrezzo2).getNome());
		assertEquals(new Attrezzo(nomeAttrezzo1,peso1).getNome(),listaStanze.get(nomeStanza1).getAttrezzo(nomeAttrezzo1).getNome());
	}
	...
	public void testAggiuntaAttrezzoAStanze_AttrezzoAggiuntoAllaSecondaStanza() {
		...
		.addAttrezzo(nomeAttrezzo2, peso2);
		Map<String, Stanza> listaStanze = labirintoBuilder.getListaStanze();
		assertEquals(new Attrezzo(nomeAttrezzo1,peso1).getNome(),listaStanze.get(nomeStanza2).getAttrezzo(nomeAttrezzo1).getNome());
		assertEquals(new Attrezzo(nomeAttrezzo2,peso2).getNome(),listaStanze.get(nomeStanza2).getAttrezzo(nomeAttrezzo2).getNome());
	}
